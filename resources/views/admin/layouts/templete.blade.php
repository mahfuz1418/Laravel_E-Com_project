                ...
                <ul class="menu-inner py-1">
                    ...
                    <li class="menu-item">
                        <a href="{{ route('addsubcategory') }}" class="menu-link">
                            ...
                            <div data-i18n="Extended UI">Add Subcategory</div>
                        </a>
                    </li>
                    <li class="menu-item">
                    ...
                    <li class="menu-item">
                        <a href="{{ route('addproduct') }}" class="menu-link">
                            ...
                            <div data-i18n="Misc">Add Product</div>
                        </a>
                    </li>
                    <li class="menu-item">
                        <a href="{{ route('allproducts') }}" class="menu-link">
                            <i class="menu-icon tf-icons bx bx-cube-alt"></i>
                            <div data-i18n="Misc">All Product</div>
                        </a>
                    </li>
                    ...
                    <li class="menu-item">
                        <a href="{{ route('pendingorders') }}" class="menu-link">
                            ...
                            <div data-i18n="Form Layouts">Pending Orders</div>
                        </a>
                    </li>
                    <li class="menu-item">
